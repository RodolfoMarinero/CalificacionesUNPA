...
class StorageRepository(private val service: StorageService) {
    ...
    suspend fun uploadProfileImage(userId: String, imageB64: String): Boolean {
       /* return try {
            val response = RetrofitClient.api.uploadFile(
                UploadRequest(
                    userId = userId,
    ...
    suspend fun getProfileImage(userId: String): String? {
       /* return try {
            RetrofitClient.api.getFile("profile_$userId").base64
        } catch (e: Exception) {
            null
        }*/
        return null
    ...
    suspend fun getSeleccionado(): ByteArray? {
        /*return try {
            val base64 = RetrofitClient.api.getSeleccionado()?.base64
    ...
    suspend fun fetchPdfList(): List<PdfData>? {
       /* return try {
            RetrofitClient.api.fetchPdfList().pdfs
        } catch (e: Exception) {
            null
        }*/
        return null
    ...
    suspend fun selectPdf(pdfId: String): Boolean {
        /*return try {
            RetrofitClient.api.selectPdf(pdfId).success
        } catch (e: Exception) {
            false
        }*/
        return false
    ...
    suspend fun resetSelected(): Boolean {
        /*return try {
            RetrofitClient.api.resetSelected().success
        } catch (e: Exception) {
            false
        }*/
        return false
